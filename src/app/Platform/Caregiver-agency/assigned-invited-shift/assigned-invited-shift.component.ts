...
@Component({
  selector: 'app-assigned-invited-shift',
  templateUrl: './assigned-invited-shift.component.html',
  styleUrls: ['./assigned-invited-shift.component.css']
})
export class AssignedInvitedShiftComponent implements OnInit {
  name = "Angular " + VERSION.major;
  title: string = 'Assigned Shifts';
  ...
  displayedColumns: string[] = ["shiftNo","releasedate", "patientname", "shifttype", "startdate", "enddate", "shifttime", "priority","assignedto","status"];  
  ...
  // method is used for export to excel --
    exportAsXLSX(): void {
      ...
      .subscribe((response: any) => {
       ...
       const workbook: XLSX.WorkBook = { Sheets: { "Agency Assigned Shift": worksheet }, SheetNames: ["Agency Open Shift"] };
       this.exportToExcelService.exportAsExcelFile(items, "Agency Assigned Shift",workbook);
      }    
      });
      }
