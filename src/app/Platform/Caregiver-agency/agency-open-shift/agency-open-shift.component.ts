...
@Component({
  selector: 'app-agency-open-shift',
  templateUrl: './agency-open-shift.component.html',
  styleUrls: ['./agency-open-shift.component.css']
})
export class AgencyOpenShiftComponent implements OnInit {
