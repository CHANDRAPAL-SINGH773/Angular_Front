...
@Component({
  selector: 'app-agency-completed-shift',
  templateUrl: './agency-completed-shift.component.html',
  styleUrls: ['./agency-completed-shift.component.css']
})
export class AgencyCompletedShiftComponent implements OnInit {
