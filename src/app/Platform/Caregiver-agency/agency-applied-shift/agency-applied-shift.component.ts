...
@Component({
  selector: 'app-agency-applied-shift',
  templateUrl: './agency-applied-shift.component.html',
  styleUrls: ['./agency-applied-shift.component.css']
})
export class AgencyAppliedShiftComponent implements OnInit {
  name = "Angular " + VERSION.major;
  title: string = 'Applied Shifts';
  ...
  displayedColumns: string[] = ["shiftNo","releasedate", "patientname", "shifttype", "startdate", "enddate", "shifttime", "priority","duration","status"];  
