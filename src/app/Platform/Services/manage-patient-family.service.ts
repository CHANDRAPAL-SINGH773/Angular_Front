...
export class ManagePatientFamilyService {
  ...
  constructor(private http: HttpClient) { }
     ...
     GetPatientFamilyListService(search:any,pageNumber:any,pageSize:any):Observable<any> {
      return this.http.get(this.ApiUrl+"PatientFamily/get/getPatientFamilyList?search="+search+"&pageNumber="+pageNumber+"&pageSize="+pageSize+"").pipe(catchError(this.handleError('Get All Agencies list')))
      }
