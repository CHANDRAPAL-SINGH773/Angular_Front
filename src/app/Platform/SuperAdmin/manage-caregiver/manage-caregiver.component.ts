...
@Component({
  selector: 'app-manage-caregiver',
  templateUrl: './manage-caregiver.component.html',
  styleUrls: ['./manage-caregiver.component.css']
})
export class ManageCaregiverComponent implements OnInit {
 ...
 //paging
  ...
  CreateFormControl():void {
    ...
    GetCareGiverList(type:any){
      ...
      this._manageCaregiverService.GetCaregiverListService(this.status,this.search,this.pageIndex,this.pagesize).subscribe((response:any)=>{
    ...
    exportAsXLSX(): void {
      ...
      this._manageCaregiverService.GetCaregiverListService(this.status,this.search,this.pageIndex,exportsize)
