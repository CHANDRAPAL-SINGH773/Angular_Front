...
@Component({
  selector: 'app-completed-shift',
  templateUrl: './completed-shift.component.html',
  styleUrls: ['./completed-shift.component.css']
})
export class CompletedShiftComponent implements OnInit {
  title: string = 'Completed Shifts';
  ...
  displayedColumns: string[] = ["shiftNo", "shiftStartDate","title", "caregiver","rating", "comments","action"];  
