...
export class AppliedShiftComponent implements OnInit {
  ...
  displayedColumns: string[] = ["shiftNo","title", "caregiver","shiftType", "shiftStartDate", "shiftEndDate", "shiftStartTime", "appliedby","action"];  
  ...
  exportAsXLSX(): void {
    ...
    .subscribe((response: any) => {
     ...
     const workbook: XLSX.WorkBook = { Sheets: { "Applied Shifts": worksheet }, SheetNames: ["Applied Shifts"] };
     this.exportToExcelService.exportAsExcelFile(items, "Applied Shifts",workbook);
    }    
    });
  }
