...
@Component({
  selector: 'app-invited-shift',
  templateUrl: './invited-shift.component.html',
  styleUrls: ['./invited-shift.component.css']
})
export class InvitedShiftComponent implements OnInit {
