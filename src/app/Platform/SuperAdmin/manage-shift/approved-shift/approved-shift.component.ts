...
@Component({
  selector: 'app-approved-shift',
  templateUrl: './approved-shift.component.html',
  styleUrls: ['./approved-shift.component.css']
})
export class ApprovedShiftComponent implements OnInit {
